...
public:
    ...
    string lookUpScopeID(SymbolInfo* entry){
        //printAllScopes();
        ScopeTable *temp = current;
    ...
    SymbolInfo* lookUpSymbol_currentScope(SymbolInfo* entry){
        //printAllScopes();
        ScopeTable *temp = current;
    ...
    void updateSymbol(string name, int offset){
        cout << " to be updated " << name << " offset " << offset << endl; 
        SymbolInfo *toBeUpdated = lookUpSymbol(new SymbolInfo(name, ""));
        if(toBeUpdated != nullptr){
            cout << "yessss" << endl;
            toBeUpdated->offset =  offset;
        }
    }
